...
export function StressRecordPage() {
    ...
    if (isLoading) {
        return <div className="flex-1 p-6 text-center text-gray-500">Loading stress records...</div>;
    }
    ...
    return (
        <div className="flex-1 p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Stress Records</h1>
